...
import java.io.*;
	...
	/////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		{
			g.addVertex("Barrackpore");
			g.addVertex("Dakshineswar");
			g.addVertex("Baranagar");
			g.addVertex("Noapara");
			g.addVertex("Titumir");
			g.addVertex("Barasta");
			g.addVertex("Howrah Moidan");
			g.addVertex("Esplanade");
			g.addVertex("Park Street");
			g.addVertex("Diamond Park");
			g.addVertex("Kavi Subhash");
			g.addVertex("Sector V");
			g.addEdge("Barrackpore", "Baranagar", 5);
			g.addEdge("Baranagar", "Dakshinerswar", 1);
			g.addEdge("Baranagar", "Noapara", 1);
			g.addEdge("Noapara", "Titumir", 2);
			g.addEdge("Noapara", "Esplanade", 4);
			g.addEdge("Barasat", "Titumir", 4);
			g.addEdge("Titumir", "Sector V", 5);
			g.addEdge("Esplanade", "Sector V", 3);
			g.addEdge("Esplanade", "Howrah Moidan", 2);
			g.addEdge("Esplanade", "Park Street", 1);
			g.addEdge("Park Street", "Diamond Park", 8);
			g.addEdge("Park Street", "Kavi Subhash", 8);
			g.addEdge("Kavi Subhash", "Sector V", 7);
